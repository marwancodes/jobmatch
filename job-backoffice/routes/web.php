...
Route::middleware(['auth', 'role:admin,company-owner,job-seeker'])->group(function () {
...
Route::middleware(['auth', 'role:admin'])->group(function () {
    ...
    Route::put('users/{id}/restore', [UserController::class, 'restore'])->name('users.restore'); // Add this resote route here because normally it's not generated by resource routes
